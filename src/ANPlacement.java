...
public class ANPlacement {
        ...
        public static int [] H7 = new int [n];
    ...
    //==============================SORTING FUNCTIONS=================================================
      public static void PlacementMaxFor(int [][] M, ArrayList<Integer> placed) throws IOException {
    	System.out.println("Tracing of Selection algorithm");
        ...
        for (int i = 0; i < M.length; i++) {
            ...
            System.out.println("The total crossing of AN " + (i + 1) + " is: " + k[i]);
        }
...
public static void PlacementMaxForTestingNoDist(int [][] M, ArrayList<Integer> placed) throws IOException {
        ...
        int [][]c;
	  	...
	  	int [][]c_CCPMax;
           ...
           // System.out.println("Placed");
            ...
            placed2.clear();
            count = -1;
            PlacementMaxForTestingNoDist(c,placed2);
...
//            H6 = 
           ...
           // System.out.println("Placed");
            ...
            System.out.println("The reduced number of crossing of our Algo. is: " + computeCrossing(sortMatrix(H3,c)));
            System.out.println(" ");
            System.out.println(" ");
            
            System.out.println("The reduced number of crossing of our Algo no Distance. is: " + computeCrossing(sortMatrix(H7,c)));
            System.out.println(" ");
            System.out.println(" ");
